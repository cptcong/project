  ...
  var e = "config",
    ...
    Ut = {
      config: {
        ...
        breakpoints: { global: { href: u, width: "*", height: "*" } },
        events: {},
      },
      isInit: u,
      lockState: v,
      ...
      defaults: {
        breakpoint: { config: v, elements: v, test: { width: v, height: v } },
        config_breakpoint: {
          containers: "100%",
          grid: {},
          href: "",
      ...
      extend: function (e, t) {
        ...
        Ut[n](t, function (n) {
          Ut[R](t[n])
            ? (Ut[R](e[n]) || (e[n] = []), Ut[H](e[n], t[n]))
            : typeof t[n] == x
            ? (typeof e[n] != x && (e[n] = {}), Ut[H](e[n], t[n]))
            : (e[n] = t[n]);
        });
      },
      ...
      getViewportDimensions: function () {
        ...
        return (
          ...
          screen[S] < r && ((r = screen[S]), (i = screen[m])),
          t !== u &&
            (Ut[e][pt]
              ? ((r = Math.min(screen[S], screen[m])),
                (i = Math.max(screen[S], screen[m])))
              : t === 90
              ? ((r = Math.max(screen[S], screen[m])),
                (i = Math.min(screen[S], screen[m])))
              : ((r = Math.min(screen[S], screen[m])),
                (i = Math.max(screen[S], screen[m])))),
          (r /= n),
          (i /= n),
      ...
      unlock: function () {
        (Ut[N] = v),
          (document.cookie =
            ...
            (Ut[e].domainLock ? "/" : window[M].pathname)),
      ...
      lock: function (t) {
        (Ut[N] = t),
          (document.cookie =
            ...
            t +
            ";expires=" +
            (Ut[e].perpetualLock ? "Thu, 1 Jan 2077 12:00:00 UTC" : 0) +
            "; path=" +
            (Ut[e].domainLock ? "/" : window[M].pathname)),
          Ut[e].pollOnLock ? Ut.poll() : window[M].reload();
      },
      ...
      changeState: function (l) {
        ...
        if (!Ut[T][ct][Ut[s]]) {
          (Ut[T][ct][Ut[s]] = { config: {}, elements: [], values: {} }),
            (m = Ut[T][ct][Ut[s]]),
          ...
          (x = "iBM"),
            ...
            N != "" &&
              ((x = "mV" + Ut[s]),
              (S = Ut[i](x)) ||
                (S = Ut[f](x, Ut.newMeta("viewport", N), et, 4)),
              m[r][V](S)),
            Ut[b][ft] >= 10 &&
              ((x = "mVIE" + Ut[s]),
              (S = Ut[i](x)) ||
                (S = Ut[f](
                  x,
                  Ut[w]("@-ms-viewport{width: device-width}"),
                  et,
                  3
                )),
              m[r][V](S));
          ...
          Ut[n](h, function (s) {
            Ut[t][h[s]][e][xt] &&
              ((x = "ss" + h[s]),
              (S = Ut[i](x)) ||
                (S = Ut[f](x, Ut.newStyleSheet(Ut[t][h[s]][e][xt]), k, 5)),
              m[r][V](S)),
              Ut[t][h[s]][r][c] > 0 &&
                Ut[n](Ut[t][h[s]][r], function (e) {
                  m[r][V](Ut[t][h[s]][r][e]);
                });
          }),
            Ut[T][a][Ut[s]] &&
      ...
      newInline: function (e) {
        ...
        return (
          Ut[b][ft] <= 8
            ? ((t = document[A]("span")),
              (t[Lt] = '&nbsp;<style type="text/css">' + e + "</style>"))
            : ((t = document[A]("style")), (t.type = Mt), (t[Lt] = e)),
          t
        );
      },
      newDiv: function (e) {
      ...
      initConfig: function (i) {
        ...
        var s = [],
          o = [];
        typeof i == x && (i[t] && (Ut[e][t] = {}), Ut[H](Ut[e], i)),
